...
*/
public class PersonEntityDao extends AbstractDao<PersonEntity, String> {
    ...
    protected final void bindValues(DatabaseStatement stmt, PersonEntity entity) {
        stmt.clearBindings();
        stmt.bindString(1, entity.getPersonId());
    ...
    public PersonEntity readEntity(Cursor cursor, int offset) {
        PersonEntity entity = new PersonEntity( //
            cursor.getString(offset + 0), // personId
    ...
    public void readEntity(Cursor cursor, PersonEntity entity, int offset) {
        entity.setPersonId(cursor.getString(offset + 0));
    ...
    @Override
    protected final String updateKeyAfterInsert(PersonEntity entity, long rowId) {
        return entity.getPersonId();
    }
    
    @Override
    public String getKey(PersonEntity entity) {
        if(entity != null) {
            return entity.getPersonId();
        } else {
            return null;
