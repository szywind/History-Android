...
//    private String[] tabTitle = {"最新发布", "最多回复", "最多喜欢"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewPager viewPager = (ViewPager) view.findViewById(R.id.forum_viewpager);
        ScrollIndicatorView scrollIndicatorView = (ScrollIndicatorView) view.findViewById(R.id.forum_indicator);
