...
public class EventDao extends AbstractDao<Event, Integer> {
    ...
    public static class Properties {
        public final static Property Event_id = new Property(0, int.class, "event_id", true, "EVENT_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EVENT\" (" + //
                "\"EVENT_ID\" INTEGER PRIMARY KEY NOT NULL ," + // 0: event_id
    ...
    protected final void bindValues(DatabaseStatement stmt, Event entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getEvent_id());
    ...
    public Event readEntity(Cursor cursor, int offset) {
        Event entity = new Event( //
            cursor.getInt(offset + 0), // event_id
    ...
    public void readEntity(Cursor cursor, Event entity, int offset) {
        entity.setEvent_id(cursor.getInt(offset + 0));
    ...
    @Override
    protected final Integer updateKeyAfterInsert(Event entity, long rowId) {
        return entity.getEvent_id();
    }
    
    @Override
    public Integer getKey(Event entity) {
        if(entity != null) {
            return entity.getEvent_id();
        } else {
            return null;
